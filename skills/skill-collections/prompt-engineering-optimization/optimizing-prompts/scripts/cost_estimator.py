#!/usr/bin/env python3
"""
ai-ml-engineering-pack - cost_estimator.py
Script to estimate the cost of running a prompt on different LLMs.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to estimate the cost of running a prompt on different LLMs."
    )
    ...
    print(f"🚀 ai-ml-engineering-pack - cost_estimator.py")
