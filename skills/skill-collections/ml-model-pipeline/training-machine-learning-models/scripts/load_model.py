#!/usr/bin/env python3
"""
ml-model-trainer - load_model.py
Loads a previously trained model artifact from a specified location.
...
def main():
    parser = argparse.ArgumentParser(
        description="Loads a previously trained model artifact from a specified location."
    )
    ...
    print(f"🚀 ml-model-trainer - load_model.py")
