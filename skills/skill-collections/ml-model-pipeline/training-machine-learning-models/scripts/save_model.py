#!/usr/bin/env python3
"""
ml-model-trainer - save_model.py
Saves the trained model artifact to a specified location.
...
def main():
    parser = argparse.ArgumentParser(
        description="Saves the trained model artifact to a specified location."
    )
    ...
    print(f"🚀 ml-model-trainer - save_model.py")
