---
name: scp-oceangraph
description: Use when you need to connect to the SciGraph SCP server for OceanGraph (Historical Marine Biodiversity Knowledge Graph / OceanGraphRAG KG built with Microsoft GraphRAG) and call its MCP tools (query_cypher, get_kg_statistics, get_entity_details, get_experiment_workflow), including streamableHttp configuration with SCP-HUB-API-KEY and Python 3.10+ usage examples.
---

# SCP-OceanGraph (SciGraph) MCP client
